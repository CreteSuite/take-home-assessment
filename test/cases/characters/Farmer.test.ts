...
describe('Given the "Farmer"', () => {
  const role = 'Farmer'
  const characterHealthAdjustment = -2
  const characterStrengthAdjustment = -1
  ...
  describe('takes a turn on the Dunshire map', () => {
    const baseHealthAdjustment = characterHealthAdjustment - 0
    const baseStrengthAdjustment = characterStrengthAdjustment - 1
    ...
    describe('with a starting health of 3 and strength of 2', () => {
      beforeEach(() => {
        health = 3
        strength = 2
      })
      ...
      describe('when the dice rolls are 1 and 2', () => {
        ...
        it('activates humility for reaching 0 health and 0 strength', () => {
          expect(character.health).toBe(12)
          expect(character.strength).toBe(12)
          expect(character.cones).toBe(1)
        })
      })
      ...
      describe('when the dice rolls are 3 and 3', () => {
        ...
        it('faints from reaching 0 health', () => {
          ...
          expect(character.strength).toBe(1)
        })
      })
  ...
  describe('takes a turn on the Brimward map', () => {
    const baseHealthAdjustment = characterHealthAdjustment - 1
    const baseStrengthAdjustment = characterStrengthAdjustment - 1
    ...
    describe('with a starting health of 4 and strength of 2', () => {
      beforeEach(() => {
        health = 4
        strength = 2
      })
    ...
    describe('with a starting health of 3 and strength of 10', () => {
      beforeEach(() => {
        health = 3
        strength = 10
      })
